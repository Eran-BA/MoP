    ...
    for name, module in model.named_modules():
        if len(list(module.children())) == 0:  # Leaf modules only
            ...
            if module_params > 0:
                ...
                param_breakdown[module_type] = param_breakdown.get(module_type, 0) + module_params
    
    print("  Parameter breakdown:")
    for module_type, params in sorted(param_breakdown.items(), key=lambda x: x[1], reverse=True):
