...
- [ ] Generalize to a lens bank via causal depthwise convs over Q/K(1…M); run CNN filters in parallel over the bank; support gate-free log-space multiplication.
