...
def main():
    ...
    for target in args.targets:
        ...
        print(f"Baseline config near target: {base_cfg} | params={base_p:,}")
        print(
            f"MoP config near target     : {mop_cfg} + {{'n_views': {args.mop_views}, 'n_kernels': {args.mop_kernels}}} | params={mop_p:,}"
        )
