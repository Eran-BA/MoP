...
def main():
    ap = argparse.ArgumentParser(
        description="CIFAR-100 experiment with dual-path gated attention (multi-hop composition)"
    )
    ...
    ap.add_argument("--out", type=str, default="results/cifar100_multihop_gates")
    # Gate weights
    ...
    csv_path = os.path.join(args.out, "cifar100_multihop_gates.csv")
